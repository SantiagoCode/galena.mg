{{-- <div class="hero is-light is-fullheight">
      ...
      <div class="navbar" data-inertia data-inertia-reveal>
        ...
        <div class="navbar-end">
          <div class="navbar-item">
            <a data-gravity  href="https://telefonica.amerinode.net/Account/Login.aspx" class="button is-dark is-inverted">
      ...
      <div class="columns level">
        <div class="column is-6">
          <p data-inertia data-inertia-reveal data-inertia-delay="600"
            class="has-text-weight-normal subtitle has-text-dark is-italic has-margin-bottom-40">Opening your mind to the
            Better</p>
        ...
        <div class="column is-offset-1 is-6" data-cursor="-inverse">
          <div class="columns intro-card-container">
            <div data-inertia data-inertia-reveal class="column is-half">
              <a href="/portafolio-de-servicios/remanufactura" data-gravity data-cursor-text="Ver más" class="image is-4by3 has-background-danger"
              ...
              <a href="/portafolio-de-servicios/gestion-de-repuestos" data-gravity data-cursor-text="Ver más" class="image has-margin-top-30 is-4by3 has-background-danger"
                style="background-image: url('@asset('images/reciclaje.jpg')') ; background-size: cover;">
                <span class="card-name has-margin-left-30 has-margin-bottom-30 has-text-white">Gestión de Repuestos</span>
              </a>
            </div>
            <div data-inertia data-inertia-reveal class="column is-half">
              <a href="/portafolio-de-servicios/gestion-de-servicios" data-gravity data-cursor-text="Ver más" class="image is-3by5 has-background-danger"
              style="background-image: url('@asset('images/gestion-de-servicio.jpg')') ; background-size: cover; background-position:center;">
              <span class="card-name has-margin-left-30 has-margin-bottom-30 has-text-white">Gestión de Servicios</span>
            </a>
            </div>
          </div>
        </div>
  ...
  <div class="hero-foot">
    <div class="container is-fluid has-padding-left-80 has-padding-bottom-15">
      <div class="buttons">
        <a href="/portafolio-de-servicios"
          data-gravity
          data-inertia
          data-inertia-reveal
