<?php
/**
 * This is a copy of the PH_List_Table class in WordPress core. This class is copied as a fallback
 * in case PH_List_Table is no longer included in core in the future.
 *
 */
...
class PH_List_Table {
	...
	function ajax_user_can() {
		die( 'function PH_List_Table::ajax_user_can() must be over-ridden in a sub-class.' );
	}

	/**
	 * Prepares the list of items for displaying.
	 * @uses PH_List_Table::set_pagination_args()
	 *
	 * @since 3.1.0
	 * @access public
	 * @abstract
	...
	function prepare_items() {
		die( 'function PH_List_Table::prepare_items() must be over-ridden in a sub-class.' );
	}
...
<?php
	...
	function get_columns() {
		die( 'function PH_List_Table::get_columns() must be over-ridden in a sub-class.' );
	}
